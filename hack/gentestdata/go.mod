module github.com/sigstore/policy-controller/hack/gentestdata

go 1.22.1

replace github.com/sigstore/policy-controller => ../..

require github.com/sigstore/policy-controller v0.0.0-00010101000000-000000000000
...
require (
	...
	knative.dev/pkg v0.0.0-20240313155908-adefab46f5e5 // indirect
